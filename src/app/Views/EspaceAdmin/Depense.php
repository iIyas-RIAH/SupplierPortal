        ...
        <div class="container px-6 mx-auto grid">
          <div class="flex justify-between">
            ...
            <div class="flex justify-between gap-x-3">
              <div class="pt-3">
                <form class="block w-max px-1 py-1 mt-4 text-lg font-medium leading-5 text-center text-white transition-colors duration-150 bg-green-600 border border-transparent rounded-lg active:bg-green-600 hover:bg-green-700 focus:outline-none focus:shadow-outline-green" action="../../Service/ImportExcel.php" method="POST" enctype="multipart/form-data">
                  <label for="file-input">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M9 3.75H6.912a2.25 2.25 0 00-2.15 1.588L2.35 13.177a2.25 2.25 0 00-.1.661V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 00-2.15-1.588H15M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859M12 3v8.25m0 0l-3-3m3 3l3-3" />
                    </svg>
                  </label>
                  <input type="file" class="hidden" id="file-input" name="excel" onchange="this.form.submit()">
                </form>
              </div>

              <div class="pt-3">
                <a class="block w-max px-1 py-1 mt-4 text-lg font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="AddDepense.php">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <table class="w-full whitespace-no-wrap">
                <thead>
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    <th class="px-4 py-3">Type Dépence</th>
                    <th class="px-4 py-3">Num Dépence</th>
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  ...
                  <?php
                  $results = mysqli_query($conn, "SELECT NUMDEPENSE, entreprise.NOM, LIBELLE, TYPEDEPENSE, ETATDEPENSE, DATEDEBUT, MONTANT FROM depense, entreprise WHERE depense.IDFOURNISSEUR = entreprise.IDFOURNISSEUR");

                  while ($ligne = mysqli_fetch_row($results)) {
                  ?>
                    <tr class="text-gray-700" onclick="window.location='InfoDepense.php?idDepense=<?php echo $ligne[0]; ?>';">
