      ...
      <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
          <div class="flex justify-between">
            ...
            <div class="pt-3">
              <a class="block w-max px-1 py-1 mt-4 text-lg font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="AddOffre.php">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
              ...
              <table class="w-full whitespace-no-wrap">
                <thead>
                  <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-gray-50">
                    <th class="px-4 py-3">Num Offre</th>
                    <th class="px-4 py-3">Libelle</th>
                    <th class="px-4 py-3">Categorie</th>
                    <th class="px-4 py-3">Date Fin</th>
                    <th class="px-4 py-3">Achteur</th>
                  </tr>
                </thead>
                <tbody class="bg-white divide-y">

                  <?php
                  $results = mysqli_query($conn, "SELECT * FROM appeloffre");

                  while ($ligne = mysqli_fetch_row($results)) {
                  ?>
                    <tr class="text-gray-700 dark:text-gray-400" onclick="window.location='InfoOffre.php?idOffre=<?php echo $ligne[0]; ?>';">
