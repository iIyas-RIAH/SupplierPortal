      ...
      <header class="z-10 py-4 bg-white shadow-md">
        <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600">
          ...
          <div class="flex justify-center flex-1 lg:mr-32">
            <form class="relative w-full max-w-xl mr-6 focus-within:text-purple-500" id="search" action="SearchFournisseur.php" method="post">
            ...
            <div class="w-full overflow-x-auto">
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y">
                  ...
                  $results = mysqli_query($conn, "SELECT fournisseur.CIN, fournisseur.NOM, fournisseur.PRENOM, fournisseur.EMAIL, fournisseur.PHONE, entreprise.NOM FROM fournisseur, entreprise WHERE fournisseur.CIN like '%$rech%' or fournisseur.NOM like '%$rech%' or fournisseur.PRENOM like '%$rech%' or fournisseur.EMAIL like '%$rech%' or fournisseur.PHONE like '%$rech%' or entreprise.NOM like '%$rech%' and entreprise.CIN = fournisseur.CIN order by fournisseur.NOM, fournisseur.PRENOM");
