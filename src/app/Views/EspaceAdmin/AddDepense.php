                    ...
                    <div class="bg-white px-8 shadow-md rounded-md py-5">
                        <div>
                            <div class="flex items-center space-x-2 text-xl font-semibold text-gray-900 leading-8 px-4 py-3">
                                ...
                                <span class="px-1">Nouvelle Depense</span>
                            </div>

                            <form method="post" action="../../Service/AddDepenseService.php" class="px-6 py-4 text-base">
                                <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                                    <div>
                                        <h4 class="py-4">NUM DEPENSE</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Num_Depense" required>
                                    </div>

                                    <div>
                                        <h4 class="py-4">LIBELLE</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Libelle" required>
                                    </div>

                                    <div>
                                        <h4 class="py-4">TYPE DEPENSE</h4>
                                        <input class="w-11/12  rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Type_Depense" required>
                                    </div>

                                    <div>
                                        <h4 class="py-4">ETAT DEPENSE</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Etat_Depense" required>
                                    </div>

                                    <div>
                                        <h4 class="py-4">FOURNISSEUR</h4>
                                        <select class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" name="Fournisseur" required>
                                            <?php
                                            $fournisseur = mysqli_query($conn, "SELECT CIN, NOM, PRENOM FROM fournisseur");
                                            while ($ligne = mysqli_fetch_row($fournisseur)) {
                                            ?>
                                    ...
                                    <div>
                                        <h4 class="py-4">DATE DEBUT</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="date" name="Date_Debut" required>
                                    </div>

                                    <div>
                                        <h4 class="py-4">DATE FIN</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="date" name="Date_Fin" required>
                                    </div>
                                </div>
