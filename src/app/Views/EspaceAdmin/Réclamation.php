...
<body>
  ...
  //$depense = mysqli_query($conn, "SELECT NUMDEPENSE FROM depense WHERE CIN = '$CIN' and DATEFIN IS NULL");
            ...
            <div class="w-full overflow-x-auto">
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y">
                  ...
                  ?>
                    <tr class="text-gray-700 dark:text-gray-400" onclick="window.location='InfoReclamation.php?idReclamation=<?php echo $ligne[0]; ?>';">
    ...
    $(document).ready(function() {
      $("#Num_Depense").change(function() {
        ...
        $.ajax({
          ...
          factures = factures.replaceAll(`"`, `'`);
          console.log(factures);
          factures = JSON.parse(factures);
          $('#Num_Facture').empty();
          factures.forEach(function(facture) {
            $('#Num_Facture').append('<option>' + facture + '</option>')
          })
        })
      })
    })
