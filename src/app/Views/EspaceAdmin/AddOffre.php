                    ...
                    <div class="bg-white px-8 shadow-md rounded-md py-5">
                        <div>
                            <div class="flex items-center space-x-2 text-xl font-semibold text-gray-900 leading-8 px-4 py-3">
                                ...
                                <span class="px-1">Nouvel Offre</span>
                            </div>

                            <form class="px-6 py-4 text-base" action="../../Service/AddOffreService.php" method="post">
                                <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                                    <div>
                                        <h4 class="py-4">NUM OFFRE</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Num_Offre" required>
                                    </div>
                                    ...
                                    <div class="col-span-2">
                                        ...
                                        <textarea class="rounded-lg border-2 border-black px-3 py-3 text-gray-700 h-24" style="width : 96%" type="text" name="Description" required></textarea>
                                    </div>

                                    <div>
                                        <h4 class="py-4">CATEGORIE</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Categorie" required>
                                    </div>

                                    <div>
                                        <h4 class="py-4">PROCESS</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Process" required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Achteur" required>
                                    </div>
                                </div>
