            ...
            <div class="w-full overflow-x-auto">
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  ...
                  $results = mysqli_query($conn, "SELECT * FROM depense WHERE NUMDEPENSE like '%$rech%' or LIBELLE like '%$rech%' or TYPEDEPENSE like '%$rech%' or ETATDEPENSE like '%$rech%' order by NUMDEPENSE");
