...
<body>
    ...
    $facture = mysqli_fetch_row(mysqli_query($conn, "SELECT ATTACHEMENT FROM facture WHERE NUMFACTURE = '$idFacture'"));
    ?>
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full overflow-y-auto">
                ...
                <div class="w-full px-14 py-8">
                    <div class="bg-white px-2 shadow-md rounded-md py-2">
                        <div id="factureFile">
            ...
            <script>
                PDFObject.embed("../../uploadFiles/<?php echo $facture[0]; ?>", "#factureFile");
            </script>
