...
<body>
    ...
    $reclamation = mysqli_fetch_row(mysqli_query($conn, "SELECT fournisseur.NOM, fournisseur.PRENOM, fournisseur.EMAIL, fournisseur.PHONE, reclamation.TITRE, reclamation.DATEM, reclamation.TEXTE, reclamation.NUMDEPENSE, reclamation.NUMFACTURE, entreprise.NOM, fournisseur.IDFOURNISSEUR FROM reclamation, fournisseur, entreprise WHERE reclamation.IDFOURNISSEUR = fournisseur.IDFOURNISSEUR and reclamation.IDM = '$idReclamation'"));
                    ...
                    <div class="bg-white px-8 shadow-md rounded-md py-5">
                        <div>
                            <div class="flex items-center space-x-2 text-xl font-semibold text-gray-900 leading-8 px-4 py-3">
                                ...
                                <span class="px-1">Réclamation</span>
                            </div>

                            <div class="px-6 py-4 text-base">
                                <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                                    <div>
                                        <h4 class="py-4">Éxpediteur</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Éxpediteur" onclick="window.location='InfoFournisseur.php?idFournisseur=<?php echo $reclamation[10]; ?>';" value="<?php echo $reclamation[0]." ".$reclamation[1]; ?>" readonly>
                                    </div>

                                    <div>
                                        <h4 class="py-4">Email</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Email" value="<?php echo $reclamation[2]; ?>" readonly>
                                    </div>

                                    <div>
                                        <h4 class="py-4">Téléphone</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Téléphone" value="<?php echo $reclamation[3]; ?>" readonly>
                                    </div>

                                    <div>
                                        <h4 class="py-4">Entreprise</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Entreprise" value="<?php echo $reclamation[9]; ?>" readonly>
                                    </div>

                                    <div>
                                        <h4 class="py-4">Num Depense</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Num_Depense" value="<?php echo $reclamation[7]; ?>" readonly>
                                    </div>

                                    <div>
                                        <h4 class="py-4">Num Facture</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Num_Facture" value="<?php echo $reclamation[8]; ?>" readonly>
                                    </div>

                                    <div>
                                        <h4 class="py-4">Date</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Date" value="<?php echo $reclamation[5]; ?>" readonly>
                                    </div>
                                    
                                    <div>
                                        <h4 class="py-4">Objet</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Objet" value="<?php echo $reclamation[4]; ?>" readonly>
                                    </div>

                                    <div class="col-span-2">
                                        <h4 class="py-4">Message</h4>
                                        <textarea class="rounded-lg border-2 border-black px-3 py-2 text-gray-700 h-28" style="width : 96%" type="text" name="Message" readonly><?php echo $reclamation[6]; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
