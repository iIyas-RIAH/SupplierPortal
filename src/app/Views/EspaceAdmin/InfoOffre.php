...
<body>
    ...
    $appeloffre = mysqli_fetch_row(mysqli_query($conn, "SELECT * FROM appeloffre WHERE NUMOFFRE = '$idOffre'"));
                    ...
                    <div class="bg-white px-8 shadow-md rounded-md py-5">
                        <div>
                            <div class="flex items-center space-x-2 text-xl font-semibold text-gray-900 leading-8 px-4 py-3">
                                ...
                                <span class="px-1">Offre</span>
                            </div>

                            <form action="../../Service/EditOffreService.php" method="post" class="px-6 py-4 text-base">
                                <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                                    <div>
                                        <h4 class="py-4">NUM OFFRE</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Num_Offre" value="<?php echo $appeloffre[0]; ?>" readonly>
                                    </div>

                                    <div>
                                        <h4 class="py-4">LIBELLE</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Libelle" value="<?php echo $appeloffre[1]; ?>">
                                    </div>

                                    <div class="col-span-2">
                                        <h4 class="py-4">DESCRIPTION</h4>
                                        <input class="rounded-lg border-2 border-black px-3 text-gray-700 h-10" style="width : 96%" type="text" name="Description" value="<?php echo $appeloffre[2]; ?>">
                                    </div>

                                    <div>
                                        <h4 class="py-4">CATEGORIE</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Categorie" value="<?php echo $appeloffre[3]; ?>">
                                    </div>

                                    <div>
                                        <h4 class="py-4">PROCESS</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Process" value="<?php echo $appeloffre[4]; ?>">
                                    </div>

                                    <div>
                                        <h4 class="py-4">DATE FIN</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="date" name="Date_Fin" value="<?php echo $appeloffre[5]; ?>">
                                    </div>

                                    <div>
                                        <h4 class="py-4">ACHTEUR</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Achteur" value="<?php echo $appeloffre[6]; ?>">
                                    </div>
                                </div>
