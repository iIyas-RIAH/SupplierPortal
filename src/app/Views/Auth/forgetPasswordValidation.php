          ...
          <div class="w-full">
            <form action="../../Service/forgetPasswordService.php" method="post">
              ...
              <label class="block text-md">
                <input class="block w-full h-7 mt-1 p-2 text-md focus:border-black focus:outline-black focus:shadow-md form-input" name="code" placeholder="********" />
              </label>
              <button class="block w-full px-4 py-2 mt-4 text-lg font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" name="validate" type="submit">
                Soumettre
              </button>
            </form>
          </div>
