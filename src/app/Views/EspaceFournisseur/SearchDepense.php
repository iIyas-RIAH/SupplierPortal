      ...
      <div class="py-4 text-gray-500">
        ...
        <ul class="mt-6">
          <li class="relative px-6 py-3">
            ...
            <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="Accueil.php">
      ...
      <header class="z-10 py-4 bg-white shadow-md">
        <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600">
          ...
          <div class="flex justify-center flex-1 lg:mr-32">
            <form class="relative w-full max-w-xl mr-6 focus-within:text-purple-500" id="search" action="" method="post">
            ...
            <div class="w-full overflow-x-auto">
              <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y">
                  ...
                  <?php include '../components/depense-search.php'; ?>
