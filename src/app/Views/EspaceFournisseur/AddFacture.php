                    ...
                    <div class="bg-white px-8 shadow-md rounded-md py-5">
                        <div>
                            <div class="flex items-center space-x-2 text-xl font-semibold text-gray-900 leading-8 px-4 py-3">
                                ...
                                <span class="px-1">Nouvelle Facture</span>
                            </div>

                            <form method="post" action="../../Service/AddFactureService.php" class="px-6 py-4 text-base" enctype="multipart/form-data">
                                <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                                    <div>
                                        <h4 class="py-4">NUM FACTURE</h4>
                                        <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Num_Facture" required>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input class="w-11/12  rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="date" name="Date_Facture" required>
                                    </div>

                                    <div>
                                        <h4 class="py-4">MONTANT HT</h4>
                                        <input class="w-11/12  rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Montant_HT" required>
                                    </div>

                                    <div>
                                        <h4 class="py-4">MONTANT TTC</h4>
                                        <input class="w-11/12  rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Montant_TTC" required>
                                    </div>

                                    <div>
                                        <h4 class="py-4">ATTACHEMENT</h4>
                                        <input class="w-11/12" type="file" name="Attachement" multiple required>
                                    </div>
