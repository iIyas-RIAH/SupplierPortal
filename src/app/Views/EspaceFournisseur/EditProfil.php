                ...
                <div class="w-full  px-14 py-10">
                    <div class="bg-white px-8 shadow-md rounded-md py-5">
                        <div class="flex items-center space-x-2 text-xl font-semibold text-gray-900 leading-8 px-4 py-3">
                            ...
                            <span class="px-1">Mon Profil</span>
                        </div>

                        <form method="post" action="../../Service/EditProfilService.php" id="form" class="px-6 py-4 text-base">
                            <div class="grid grid-cols-2 gap-x-12 gap-y-6">
                                <div>
                                    <h4 class="py-4">NOM</h4>
                                    <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Nom" value="<?php echo $resultat[2]; ?>" required>
                                </div>

                                <div>
                                    <h4 class="py-4">PRÉNOM</h4>
                                    <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Prenom" value="<?php echo $resultat[3]; ?>" required>
                                </div>

                                <div>
                                    <h4 class="py-4">EMAIL</h4>
                                    <input class="w-11/12  rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Mail" value="<?php echo $resultat[4]; ?>" required>
                                </div>

                                <div>
                                    <h4 class="py-4">MOBILE</h4>
                                    <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Phone" value="<?php echo $resultat[5]; ?>" required>
                                </div>

                                <div>
                                    <h4 class="py-4">FAX</h4>
                                    <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="text" name="Fax" value="<?php echo $resultat[7]; ?>" required>
                                </div>

                                <div>
                                    <h4 class="py-4">TYPE PERSONE</h4>
                                    <select class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" name="TypePersonne" required>
                                        <option value="Représentant légal" <?php echo ($resultat[5] === 'Représentant légal') ? "selected" : "" ?>>Représentant légal</option>
                                        <option value="Habilité" <?php echo ($resultat[5] === 'Habilité') ? "selected" : "" ?>>Habilité</option>
                                    </select>
                                </div>

                                <div>
                                    <h4 class="py-4">MOT DE PASSE</h4>
                                    <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="password" name="passwd">
                                </div>

                                <div>
                                    <h4 class="py-4">CONFIRMATION MOT DE PASSE</h4>
                                    <input class="w-11/12 rounded-lg border-2 border-black px-3 text-gray-700 h-10" type="password" name="passwd2">
                                </div>
